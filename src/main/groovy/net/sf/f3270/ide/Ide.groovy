...
class Ide {
    ...
    private static ListModel getListCommandsListModel() {
        return new AbstractListModel() {
            ...
            Object getElementAt(int i) {
                new Command("write", new Parameter("label", "whatever"), new Parameter("value", "something"))
            }
        }
    }
    ...
    private void comboBoxCommandActionPerformed(ActionEvent evt) {
        ...
        if (command == "Write") {
            ...
            labelMatch.setEnabled(true)
            comboBoxMatch.setEnabled(true)
        } else if (command == "Enter" || command == "SysReq" || command == "Clear") {
            comboBoxN.setEnabled(false)
